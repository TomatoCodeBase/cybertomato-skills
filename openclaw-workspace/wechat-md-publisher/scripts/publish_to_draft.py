...
def main():
    ...
    if not thumb_media_id:
        thumb_media_id = "A8koy-PJTeaK9wzaktwvFTo_5RejWZYgH-QxNomKRt1qHCZA1BI16kLNgu1UVKii"
        print("✓ 使用测试封面")
    ...
    if media_id:
        ...
        if thumb_media_id == "A8koy-PJTeaK9wzaktwvFTo_5RejWZYgH-QxNomKRt1qHCZA1BI16kLNgu1UVKii":
            print("🎨 封面: 测试封面")
        else:
            print("🎨 封面: 自定义封面")
