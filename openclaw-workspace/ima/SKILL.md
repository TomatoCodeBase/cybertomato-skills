...
description: |
  ...
  ⚠️ 触发规则（2026-03-27 番茄要求）：必须包含"ima"字样才触发此技能。
  示例："ima知识库"、"搜一下ima笔记"、"上传到ima"。
  仅说"知识库"、"笔记"、"帮我记一下"等不触发 ima-skill（避免与 Get笔记、Obsidian 等冲突）。
...
| "读一下ima笔记" | ✅ | 包含 ima |
| "上传到ima" | ✅ | 包含 ima |
| "知识库搜一下XX" | ❌ | 不含 ima，可能指其他知识库 |
| "帮我记一下" | ❌ | 不含 ima，触发 Get笔记 |
| "搜索笔记" | ❌ | 不含 ima，触发 Get笔记 |
